      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          >
            <p
              className={`${
                sizes.includes("S") ? "bg-gray-400" : "bg-slate-200"
          ...
          >
            <p
              className={`${
                sizes.includes("M") ? "bg-gray-400" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              M
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("L") ? "bg-gray-400" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              L
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XL") ? "bg-gray-400" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XL
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XXL") ? "bg-gray-400" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XXL
            </p>
